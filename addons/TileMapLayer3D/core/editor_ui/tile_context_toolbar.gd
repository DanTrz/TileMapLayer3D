...
func _update_mesh_mode_controls_visibility(mesh_mode: int) -> void:
	var is_arch: bool = mesh_mode == GlobalConstants.MeshMode.FLAT_ARCH_CORNER or mesh_mode == GlobalConstants.MeshMode.FLAT_ARCH_TWO or mesh_mode == GlobalConstants.MeshMode.FLAT_ARCH
